            ...
            <tbody>
                <c:forEach var="editora" items="${editoras}">
                    <tr>
                        ...
                        <td align="center">
                            <a href="EditoraExcluir?idEditora=${editora.idEditora}">Excluir</a></td>
                        <td align="center">
                            <a href="EditoraCarregar?idEditora=${editora.idEditora}">Alterar</a></td>
                    </tr>
                </c:forEach>
            </tbody>
        </table>
